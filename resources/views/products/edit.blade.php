...
@section('content')
<div class="container">
    <h3 class="title-main">Sửa sản phẩm</h3>
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tax_code" name="tax_code" value="{{ old('tax_code', $product->tax_code) }}" required>
        </div>
        <div class="mb-3">
            <label for="material_code" class="form-label">Mã vật tư*</label>
            <input type="text" class="form-control" id="material_code" name="material_code" value="{{ old('material_code', $product->material_code) }}" required>
        </div>
        <div class="mb-3">
